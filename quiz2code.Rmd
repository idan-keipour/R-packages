...
for (r in 1:R) {
  ...
  # Compute naive estimator of mu (MLE plug-in)
  ...
  bias_naive_vec[r] <- mu_hat - mu_true
...
bias_naive <- mean(bias_naive_vec)
...
cat(sprintf("Mean Estimate (Naive MLE):             %.6f\n", mean(mu_hat_vec)))
cat(sprintf("Bias (Naive MLE):                      %.6f\n", bias_naive))
